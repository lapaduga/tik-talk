...
@Component({
  ...
  imports: [ChatsBtn, AsyncPipe, RouterLink, RouterLinkActive, ReactiveFormsModule],
          ...
          .pipe(
            ...
            map(inputValue => {
              return chats.filter(chat => {
                return `${chat.userFrom.lastName} ${chat.userFrom.firstName}`.toLowerCase().includes(inputValue!.toLowerCase()) || null;
              })
            })
          )
      })
